            ...
            try
            {
                ...
                if (blInvoice)
                {
                    strSql = string.Format(@" SELECT CB04002,SUM(OA01020) OA01020,SUM(OA01022) OA01022,
                        ...
                        FROM (
		                        SELECT CB04002,OB01007*OB01008 OA01020,round((OB01009/OA01021/OA01060),2) OA01022,OA01002,CA01001,OA01044
		                        FROM OA01 
	                        ...
	                        UNION ALL
		                        SELECT CB04002,OB01007*OB01008*OA01016 AS OA01020,round((OB01009/OA01021/OA01060),2)*OA01016 AS OA01022
	                        ...
	                        UNION ALL
		                        SELECT CB04002,OB01007*OB01008*OA01018 AS OA01020,round((OB01009/OA01021/OA01060),2)*OA01018 AS OA01022, OA01002,CA01001,OA01044
		                        FROM OA01 
		                        INNER JOIN OB01 ON OA01999 = OB01002
		                        INNER JOIN OC01 ON OB01999 = OC01003
		                        INNER JOIN CA01 ON CA01001 = OA01038                                       
	                        ...
	                        UNION ALL
		                        SELECT CB04002,OB01007*OB01008*(1-OA01016-OA01018) AS OA01020,round((OB01009/OA01021/OA01060),2)*(1-OA01016-OA01018) AS OA01022,OA01002 ,CA01001,OA01044
		                        FROM OA01 
		                        INNER JOIN OB01 ON OA01999 = OB01002
		                        INNER JOIN OC01 ON OB01999 = OC01003
		                        INNER JOIN CA01 ON CA01001 = OA01038                                       
                    ...
                    strSql = string.Format(@" SELECT * ,Oa01022-OA01019*1.15 as Profit FROM
                        (
							...
							FROM (
                                ...
                                ,round((OB01009/OA01021/OA01060),2) OA01022
		                        FROM OA01 
		                        INNER JOIN OB01 ON OA01999 = OB01002
		                        INNER JOIN OC01 ON OB01999 = OC01003
		                        INNER JOIN CA01 ON CA01001 = OA01038                                       
	                            ...
	                            UNION ALL
		                        SELECT OA01002 ,CA01003 ,UA01004 ,UA01005,OA01019,OA01009
                                ,round((OB01009/OA01021/OA01060),2)*OA01016 OA01022
		                        FROM OA01 
		                        INNER JOIN OB01 ON OA01999 = OB01002
		                        INNER JOIN OC01 ON OB01999 = OC01003
		                        INNER JOIN CA01 ON CA01001 = OA01038  
	                            ...
	                            UNION ALL
								SELECT OA01002 ,CA01003 ,UA01004 ,UA01005,OA01019,OA01009
                                ,round((OB01009/OA01021/OA01060),2)*OA01018 OA01022		                        
                                FROM OA01 
		                        INNER JOIN OB01 ON OA01999 = OB01002
		                        INNER JOIN OC01 ON OB01999 = OC01003
		                        INNER JOIN CA01 ON CA01001 = OA01038                                       
	                            ...
	                            UNION ALL
							    SELECT OA01002 ,CA01003 ,UA01004 ,UA01005,OA01019,OA01009
                                ,round((OB01009/OA01021/OA01060),2)*(1-OA01016-OA01018) OA01022		                        
                                FROM OA01 
		                        INNER JOIN OB01 ON OA01999 = OB01002
		                        INNER JOIN OC01 ON OB01999 = OC01003
		                        INNER JOIN CA01 ON CA01001 = OA01038                                       
                        ...
                        FROM (
	                        ...
	                        FROM (
		                         SELECT CA01001,CA01003,CA01004,UA01001,UA01004,UA01005
			                        ,CB04002,OB01007*OB01008 OA01020,round((OB01009/OA01021/OA01060),2) OA01022,OA01002,OA01003
		                         FROM OA01
	                        ...
	                        FROM (
		                         SELECT CA01001,CA01003,CA01004,UA01001,UA01004,UA01005
			                        ,CB04002,OB01007*OB01008*OA01016 AS OA01020,round((OB01009/OA01021/OA01060),2)*OA01016 AS OA01022,OA01002,OA01003
		                         FROM OA01
		                         INNER JOIN OB01 on OB01002 = OA01999 
		                         INNER JOIN OC01 on OC01003 = OB01999
		                         INNER JOIN UA01 ON UA01005 = OA01015 
	                        ...
	                        FROM (
		                         SELECT CA01001,CA01003,CA01004,UA01001,UA01004,UA01005
			                        ,CB04002,OB01007*OB01008*OA01018 AS OA01020,round((OB01009/OA01021/OA01060),2)*OA01018 AS OA01022 ,OA01002,OA01003
		                         FROM OA01
		                         INNER JOIN OB01 on OB01002 = OA01999 
		                         INNER JOIN OC01 on OC01003 = OB01999
		                         INNER JOIN UA01 ON UA01005 = OA01017 
	                        ...
	                        FROM (
		                         SELECT CA01001,CA01003,CA01004,UA01001,UA01004,UA01005
			                        ,CB04002,OB01007*OB01008*(1-OA01016-OA01018) AS OA01020,round((OB01009/OA01021/OA01060),2)*(1-OA01016-OA01018) AS OA01022,OA01002,OA01003
		                         FROM OA01
		                         INNER JOIN OB01 on OB01002 = OA01999 
		                         INNER JOIN OC01 on OC01003 = OB01999
		                         INNER JOIN UA01 ON UA01001 = OA01013
            ...
            try
            {
                ...
                if (blInvoice)
                {
                    strSql = string.Format(@"  SELECT CB01002,SUM(OA01020) OA01020,SUM(OA01022) OA01022,
                        ...
                        FROM (
		                        SELECT CB01002,OB01007*OB01008 OA01020,round((OB01009/OA01021/OA01060),2) OA01022,OA01002,CA01001,OA01044
		                        FROM OA01 
		                        INNER JOIN OB01 ON OA01999 = OB01002
		                        INNER JOIN OC01 ON OB01999 = OC01003
		                        INNER JOIN CA01 ON CA01001 = OA01038                                       
	                        ...
	                        UNION ALL 
		                        SELECT CB01002,OB01007*OB01008*OA01018 AS OA01020
			                        ,round((OB01009/OA01021/OA01060),2)*OA01018 AS OA01022
			                        , OA01002,CA01001,OA01044
		                        FROM OA01 
		                        INNER JOIN OB01 ON OA01999 = OB01002
		                        INNER JOIN OC01 ON OB01999 = OC01003
	                        ...
	                        UNION ALL 
		                        SELECT CB01002,OB01007*OB01008*(1-OA01016-OA01018) AS OA01020
			                        ,round((OB01009/OA01021/OA01060),2)*(1-OA01016-OA01018) AS OA01022
			                        ,OA01002
			                        ,CA01001,OA01044
		                        FROM OA01 
		                        INNER JOIN OB01 ON OA01999 = OB01002
            ...
            try
            {
                ...
                if (blInvoice)
                {
                    strsql = string.Format(@" SELECT OA01002,CA01003,UA01001,UA01005,SUM(OA01022) OA01022,CB02002,CB04002,OB02002,OA01045
                                            ...
                                            FROM (
	                                            SELECT OA01002,CA01003,UA01001,UA01005,round((OB01009/OA01021/OA01060),2) OA01022
                                            ...
                                            SELECT OA01002,CA01003,UA01001,UA01005,SUM(OA01022) OA01022,CB02002,CB04002,OB02002,OA01045
                                                   ,Province,get240,get220,OA01028,CA01009,CA01010
                                            FROM (
	                                            SELECT OA01002,CA01003,UA01001,UA01005,round((OB01009/OA01021/OA01060),2)*OA01016 AS OA01022,CB02002
                                            ...
                                            SELECT  OA01002,CA01003,UA01001,UA01005,SUM(OA01022) OA01022,CB02002,CB04002,OB02002,OA01045
                                                   ,Province,get240,get220,OA01028,CA01009,CA01010
                                            FROM (
	                                            SELECT OA01002,CA01003,UA01001,UA01005,round((OB01009/OA01021/OA01060),2)*OA01018 AS OA01022,CB02002
				                                            ,CB04002,OB02002,OA01045,P.GA03002 Province ,GA05003 get240
				                                            ,GA06003 get220,OA01028,CA01009,CA01010
	                                            FROM OA01
	                                            INNER JOIN UA01 ON UA01005 = OA01017  
                                            ...
                                            SELECT OA01002,CA01003,UA01001,UA01005,SUM(OA01022) OA01022,CB02002,CB04002,OB02002,OA01045
                                                   ,Province,get240,get220,OA01028,CA01009,CA01010
                                            FROM (
	                                            SELECT OA01002,CA01003,UA01001,UA01005,round((OB01009/OA01021/OA01060),2)*(1-OA01016-OA01018) AS OA01022,CB02002
				                                            ,CB04002,OB02002,OA01045,P.GA03002 Province ,GA05003 get240
				                                            ,GA06003 get220,OA01028,CA01009,CA01010
	                                            FROM OA01
	                                            INNER JOIN UA01 ON UA01001 = OA01013 
                ...
                if (blInvoice)
                {
                    strsql = string.Format(@" SELECT UA01005,SUM(DISTINCT COUNT) count,SUM(sumrmb)sumrmb,SUM(sumus) sumus
                        ...
                        (
	                        ...
	                        FROM(
		                        SELECT  UA01001,UA01004,UA01005,UA01013,OB01007*OB01008 OA01020,round((OB01009/OA01021/OA01060),2) OA01022,OA01002
		                        FROM OA01  
		                        INNER JOIN UA01 ON UA01001 = OA01013
		                        INNER JOIN OB01 ON OB01002=OA01999 
		                        INNER JOIN OC01 ON OC01003=OB01999
	                        ...
	                        SELECT  UA01001,UA01004,UA01005,COUNT(DISTINCT OA01002) count,
				                        sum(OA01020) sumrmb ,sum(OA01022) sumus 
	                        FROM(
		                        SELECT  UA01001,UA01004,UA01005,UA01013,OB01007*OB01008*OA01016 AS OA01020,round((OB01009/OA01021/OA01060),2)*OA01016 AS OA01022,OA01016,OA01002
		                        FROM OA01  
		                        INNER JOIN UA01 ON UA01005 = OA01015 
		                        INNER JOIN OB01 ON OB01002=OA01999 
		                        INNER JOIN OC01 ON OC01003=OB01999
	                        ...
	                        SELECT  UA01001,UA01004,UA01005,COUNT(DISTINCT OA01002) count,
				                        sum(OA01020) sumrmb ,sum(OA01022) sumus 
	                        FROM(
		                        SELECT  UA01001,UA01004,UA01005,UA01013,OB01007*OB01008*OA01018 AS OA01020,round((OB01009/OA01021/OA01060),2)*OA01018 AS OA01022,OA01018,OA01002
		                        FROM OA01  
		                        INNER JOIN UA01 ON UA01005 = OA01017 
		                        INNER JOIN OB01 ON OB01002=OA01999 
		                        INNER JOIN OC01 ON OC01003=OB01999
	                        ...
	                        SELECT  UA01001,UA01004,UA01005,COUNT(DISTINCT OA01002) count,
				                        sum(OA01020) sumrmb ,sum(OA01022) sumus 
	                        FROM(
		                        SELECT  UA01001,UA01004,UA01005,UA01013,OB01007*OB01008*(1-OA01016-OA01018) AS OA01020,round((OB01009/OA01021/OA01060),2)*(1-OA01016-OA01018) AS OA01022,OA01018,OA01016,OA01002
		                        FROM OA01  
		                        INNER JOIN UA01 ON UA01001 = OA01013
		                        INNER JOIN OB01 ON OB01002=OA01999 
		                        INNER JOIN OC01 ON OC01003=OB01999
                      ...
                      SELECT '' YEARS,COUNT(distinct CustomerNum) CUSTOMERCOUNT
                                        ...
                                        FROM (
			                                        SELECT DATEPART(YEAR,OA01009) AS YEARS , 
			                                               ...
			                                               OA01002 AS OrderNum,
			                                              round((OB01009/OA01021/OA01060),2) OA01022 ,OB01007*OB01008 OA01020
		                                            FROM dbo.OA01 
            ...
            try
            {
                ...
                if (blInvoice)
                {
                    strSql = string.Format(@" SELECT CB03002,SUM(OA01020) OA01020,SUM(OA01022) OA01022,
	                            ...
	                            SUM(CASE WHEN OA01044=1 THEN OA01044 ELSE 0 END ) as OA01044  
                            FROM (
		                            SELECT CB03002, OB01007*OB01008 OA01020,round((OB01009/OA01021/OA01060),2) OA01022,OA01002,CA01001,OA01044
		                            FROM OA01 
		                            INNER JOIN OB01 ON OA01999 = OB01002
		                            INNER JOIN OC01 ON OB01999 = OC01003
		                            INNER JOIN CA01 ON CA01001 = OA01038                                       
            ...
            try
            {
                ...
                if (blInvoice)
                {
                    strSql = string.Format(@"
	                            ...
	                            SUM(CASE WHEN OA01044=1 THEN OA01044 ELSE 0 END ) as OA01044  
                            FROM (
		                            SELECT CB02002, OB01007*OB01008 OA01020,round((OB01009/OA01021/OA01060),2) OA01022,OA01002,CA01001,OA01044
			                            ,ROW_NUMBER() OVER(PARTITION BY OA01002 ORDER BY OA01009 DESC) NUM
		                            FROM OA01 
		                            INNER JOIN OB01 ON OA01999 = OB01002
		                            INNER JOIN OC01 ON OB01999 = OC01003
                    ...
                    strSql = string.Format(@"SELECT GA03001,GA03002 ProvinceName,CityName,count(distinct CustomerNum) CustomerNum
                            ...
                            FROM (
		                            SELECT P.GA03001,P.GA03002, OA01038 AS  CustomerNum,
			                               ...
			                               OA01044 AS NewCustomerNum,
			                               OA01002 AS OrderNum,
			                               round((OB01009/OA01021/OA01060),2) AS Amout
		                            FROM dbo.OA01 
		                            JOIN dbo.CA01 ON OA01038 = CA01001
		                            JOIN dbo.UA01 ON UA01001 = OA01013 	
		                            JOIN dbo.OB01 ON OA01999 = OB01002
	                            ...
	                            UNION ALL 
		                            SELECT P.GA03001,P.GA03002 , OA01038 AS  CustomerNum,
											  GA03.GA03002 CityName,
				                               ...
				                               OA01002 AS OrderNum,
				                               round((OB01009/OA01021/OA01060),2)*OA01016 AS Amout
		                            FROM dbo.OA01  
		                            JOIN dbo.CA01 ON OA01038 = CA01001
		                            JOIN dbo.UA01 ON UA01005 = OA01015  	
		                            JOIN dbo.OB01 ON OA01999 = OB01002
	                            ...
	                            SELECT P.GA03001,P.GA03002 , OA01038 AS  CustomerNum,
											 GA03.GA03002 CityName,
				                              (case when OA01044=1 then OA01044 else 0 end )  AS NewCustomerNum,
				                               OA01002 AS OrderNum,
				                               round((OB01009/OA01021/OA01060),2)*OA01018 AS Amout
	                            FROM dbo.OA01 
	                            JOIN dbo.CA01 ON OA01038 = CA01001
                                JOIN dbo.GA03 ON GA03001=CA01013
                                JOIN dbo.GA03 P ON GA03.GA03003 = P.GA03001
	                            ...
	                            UNION ALL 
		                            SELECT  P.GA03001,P.GA03002 , OA01038 AS  CustomerNum,
					                               ...
					                               (case when OA01044=1 then OA01044 else 0 end )  AS NewCustomerNum,
					                               OA01002 AS OrderNum,
					                               round((OB01009/OA01021/OA01060),2)*(1-OA01016-OA01018) AS Amout
		                            FROM dbo.OA01 
		                            JOIN dbo.CA01 ON OA01038 = CA01001
                                    JOIN dbo.GA03 ON GA03001=CA01013
                                    JOIN dbo.GA03 P ON GA03.GA03003 = P.GA03001
                ...
                if (blInvoice)
                {
                    strSql = string.Format(@" SELECT CA01001,CA01003,SUM(OrderMoney) OrderMoney,
                            ...
                            FROM (SELECT CA01001 , CA01003 ,
                                         SUM(round((OB01009/OA01021/OA01060),2)) OrderMoney,
                                          OA01002 OrderCount,
                                  ...
                                  SELECT CA01001 , CA01003 ,
                                         SUM(round((OB01009/OA01021/OA01060),2)*OA01016) OrderMoney,
                                         OA01002 OrderCount,
                                         SUM(CASE WHEN OC01014 = 1 THEN 1 ELSE 0 END) InvoicedCount
                                  FROM ( SELECT CA01001,CA01003,OA01002,OC01014,OA01022,OB01009,OA01021,OA01016
	                               ...
	                               UNION ALL
                                   SELECT CA01001 , CA01003 ,
                                          SUM(round((OB01009/OA01021/OA01060),2)*OA01018) OrderMoney,
                                          OA01002 OrderCount,
                                          SUM(CASE WHEN OC01014 = 1 THEN 1 ELSE 0 END) InvoicedCount
                                   ...
                                   UNION ALL                        
                                   SELECT CA01001 , CA01003 ,
                                          SUM(round((OB01009/OA01021/OA01060),2)*(1-OA01016-OA01018)) OrderMoney,
                                          OA01002 OrderCount,
                                          SUM(CASE WHEN OC01014 = 1 THEN 1 ELSE 0 END) InvoicedCount
							...
							FROM(
								SELECT * 
									FROM(
									   ...
									   FROM (
											SELECT  UA01005,round((OB01009/OA01021/OA01060),2) OA01022,OA01054
											FROM OA01
											JOIN CA01 ON CA01001 = OA01038
											LEFT JOIN CB04 ON CB04001 = CA01020
											JOIN UA01 ON UA01001 = OA01013 
									...
									SELECT * 
										FROM (
											SELECT UA01005,SUM(OA01022) OA01022,SUM(DISTINCT(CASE WHEN OA01054=1 THEN OA01054 ELSE 0 END )) OA01054
									   FROM (
											SELECT  UA01005,round((OB01009/OA01021/OA01060),2)*OA01016 AS OA01022,OA01054
											FROM OA01
											JOIN CA01 ON CA01001 = OA01038
											LEFT JOIN CB04 ON CB04001 = CA01020
											JOIN UA01 ON UA01005 = OA01015  
									...
									SELECT * 
										FROM (
											SELECT UA01005,SUM(OA01022) OA01022,SUM(DISTINCT(CASE WHEN OA01054=1 THEN OA01054 ELSE 0 END )) OA01054
									   FROM (
											SELECT  UA01005,round((OB01009/OA01021/OA01060),2)*OA01018 AS OA01022,OA01054
											FROM OA01
											JOIN CA01 ON CA01001 = OA01038
											LEFT JOIN CB04 ON CB04001 = CA01020
											JOIN UA01 ON UA01005 = OA01017 
									...
									SELECT * 
										FROM (
											SELECT UA01005,SUM(OA01022) OA01022,SUM(DISTINCT(CASE WHEN OA01054=1 THEN OA01054 ELSE 0 END )) OA01054
											FROM (
												SELECT  UA01005,round((OB01009/OA01021/OA01060),2)*(1-OA01016-OA01018) AS OA01022,OA01054
												FROM OA01
												JOIN CA01 ON CA01001 = OA01038
												LEFT JOIN CB04 ON CB04001 = CA01020
												JOIN UA01 ON UA01001 = OA01013
                    ...
                    strsql = string.Format(@"  select OA01001,OA01002,OA01009,OA01013,CA01001,CA01003,UA01004,UA01005,UA01013 ,
                                       ...
                                       from (
                                        ...
                                        (   SELECT  OA01001,OA01002,OA01009,OA01013,CA01001,CA01003,UA01004,UA01005,UA01013 ,
                                                    ...
                                                    OB01007*OB01008 OA01020,round((OB01009/OA01021/OA01060),2) OA01022
                                            FROM OA01 
                                                   INNER JOIN OB01 ON OA01999 = OB01002
                                                   INNER JOIN OC01 ON OB01999 = OC01003
                                                   INNER JOIN CA01 ON CA01001 = OA01038                                       
                                        ...
                                        (   SELECT  OA01001,OA01002,OA01009,OA01013,CA01001,CA01003,UA01004,UA01005,UA01013 ,
                                                   CA01013 ProvinceId ,CA01013 ProvinceName,CB04002,OA01021,OA01015,OA01017,OA01044,
                                                   OB01007*OB01008*OA01016 AS OA01020,round((OB01009/OA01021/OA01060),2)*OA01016 AS OA01022
                                            FROM OA01 
                                                INNER JOIN OB01 ON OA01999 = OB01002
                                                INNER JOIN OC01 ON OB01999 = OC01003
                                                INNER JOIN CA01 ON CA01001 = OA01038                                       
                                        ...
                                        (    SELECT  OA01001,OA01002,OA01009,OA01013,CA01001,CA01003,UA01004,UA01005,UA01013 ,
                                                   CA01013 ProvinceId ,CA01013 ProvinceName,CB04002,OA01021,OA01015,OA01017,OA01044,
                                                   OB01007*OB01008*OA01018 AS OA01020,round((OB01009/OA01021/OA01060),2)*OA01018 AS OA01022
                                            FROM OA01 
                                            INNER JOIN OB01 ON OA01999 = OB01002
                                            INNER JOIN OC01 ON OB01999 = OC01003
                                            INNER JOIN CA01 ON CA01001 = OA01038                                       
                                         ...
                                         (    SELECT  OA01001,OA01002,OA01009,OA01013,CA01001,CA01003,UA01004,UA01005,UA01013 ,
                                                   CA01013 ProvinceId ,CA01013 ProvinceName,CB04002,OA01021,OA01015,OA01017,OA01044,
                                                   OB01007*OB01008*(1-OA01016-OA01018) AS OA01020,round((OB01009/OA01021/OA01060),2)*(1-OA01016-OA01018) AS OA01022
                                            FROM OA01 
                                                INNER JOIN OB01 ON OA01999 = OB01002
                                                INNER JOIN OC01 ON OB01999 = OC01003
                                                INNER JOIN CA01 ON CA01001 = OA01038                                       
        ...
        public DataSet ExportPendingAlertPage(string strWhereAdd)
        {
            ...
            try
            {
                ...
                string strsql = string.Format(@" SELECT
	                            ...
	                            ) AND (OA01003 = 1 OR OA01003 =3) and OC01010 <> 1 {0} ", strWhereAdd);
        ...
        public DataSet ExportWeeklyPendingPage(string strWhereAdd)
        {
            ...
            try
            {
                ...
                string strsql = string.Format(@" SELECT  OA01002,OB01005,OB01007,CAST(OB01008 AS DECIMAL(18,2)) OB01008,OA01053,
                                       ...
                                       INNER JOIN UA01 ON UA01001 = OA01013
                                       INNER JOIN OC01 ON(OC01003=OB01999) 
                                WHERE OB01997 = 0  AND (OA01003 = 1 OR OA01003 =3)  and OC01010 <> 1 {0}
                                 AND NOT EXISTS(
		                            SELECT TOP 1 1
		                            FROM dbo.OC01  
		                            JOIN dbo.OB01 ON (OC01003=OB01999) 
            ...
            try
            {
                string strSql = string.Format(@"
                                          SELECT OA01009,OA01002,CA01002,CA01003,CA01009 
                                                    ...
                                                    / OA01021 / OA01060 ), 2) ELSE ROUND(( OB01007 * OB01008
                                                    / OA01021 / OA01060 ), 2) END  OA01022 
        ...
        public DataTable GetOA01020andOA01022ByOA01002(string oa01002)
        {
            ...
            try
            {
                string strSql = string.Format(@"
                    ...
                    from (
	                    SELECT OB01007*OB01008 OA01020,round((OB01009/OA01021/OA01060),2) OA01022
	                    FROM OA01 
	                    INNER JOIN OB01 ON OA01999 = OB01002
	                    INNER JOIN OC01 ON OB01999 = OC01003
	                    INNER JOIN CA01 ON CA01001 = OA01038                                       
	                    ...
	                    UNION ALL 
	                    SELECT OB01007*OB01008*OA01016 AS OA01020,round((OB01009/OA01021/OA01060),2)*OA01016 AS OA01022
	                    FROM OA01 
	                    INNER JOIN OB01 ON OA01999 = OB01002
	                    INNER JOIN OC01 ON OB01999 = OC01003
	                    INNER JOIN CA01 ON CA01001 = OA01038                                       
	                    ...
	                    UNION ALL 
	                    SELECT OB01007*OB01008*OA01018 AS OA01020,round((OB01009/OA01021/OA01060),2)*OA01018 AS OA01022
	                    FROM OA01 
	                    INNER JOIN OB01 ON OA01999 = OB01002
	                    INNER JOIN OC01 ON OB01999 = OC01003
	                    INNER JOIN CA01 ON CA01001 = OA01038                                       
	                    ...
	                    UNION ALL 
	                    SELECT OB01007*OB01008*(1-OA01016-OA01018) AS OA01020,round((OB01009/OA01021/OA01060),2)*(1-OA01016-OA01018) AS OA01022
	                    FROM OA01 
	                    INNER JOIN OB01 ON OA01999 = OB01002
	                    INNER JOIN OC01 ON OB01999 = OC01003
	                    INNER JOIN CA01 ON CA01001 = OA01038                                       
