    ...
    public class OrderBLL
    {
        ...
        public DataTable SelectOrderPayment(string strWhere)
        {
            ...
            try
            {
                string strSql = string.Format(@"SELECT [OP01001] ,[OP01002] ,[OP01003] ,[OP01004] ,[OP01005]
                                                      ...
                                                      ,[OP01011] ,[OP01012] ,[OP01013] ,[OP01014] ,[OP01015]
                                                      ,[OP01016] ,[OP01017] ,[OP01018] ,[OP01019] ,[OP01020]
                                                      ,[OP01021] ,[OP01022] ,[OP01023] ,[OP01997] ,[OP01998] ,[OP01999]
        ...
        public int GetFailDelivery(int ca01001)
        {
            string strSql = string.Format(@"select COUNT(1) rows from OA01
                INNER JOIN OB01 on OB01002 = OA01999 
                INNER JOIN OC01 on OC01003 = OB01999
                where OA01997 = 0 AND  OA01003 = 1 and OC01010 = 0 and OC01007 = 1 and OA01038={0}", ca01001);
            object obj = null;//用于接收存储过程返回值
        ...
        {
            string strSql = string.Format(@"SELECT ISNULL(SUM(OP01016),0) OP01016,ISNULL(MAX(DATEDIFF(day,b.DebtsDays,getdate())),0) DebtsDays
                        FROM OA01 a
                        INNER JOIN CA01 ON CA01001 = OA01038
                        INNER JOIN UA01 ON UA01001 = OA01013
                        INNER JOIN OP01 ON OA01999 = OP01003
                        ...
                        WHERE OA01997 = 0 AND  OA01003 = 1 AND OP01016 > 0 and OA01038={0}", ca01001);
            object obj = null;//用于接收存储过程返回值
            DataSet ds = Provider.ReturnDataSetByDataAdapter(strSql, 0, ref obj, null);
            return ds.Tables[0];
        }
