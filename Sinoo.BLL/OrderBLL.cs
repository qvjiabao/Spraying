...
namespace Sinoo.BLL
{
    ...
    public class OrderBLL
    {
        ...
        public DataTable SelectOrderBaseForListById(string _OA01001)
        {
            ...
            try
            {
                string strSql = string.Format(@" SELECT
                                ...
                                ,OB02001,OB02002,UA01001,UA01004,OD01003,OA01054
                                FROM OA01
                                INNER JOIN OB02 ON OB02001 = OA01025
                                INNER JOIN UA01 ON UA01001 = OA01013
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable GetDebtsList(int pageIndex, int pageSize, int? userId, ref object obj)
        {
            DataSet ds;
            try
            {
                ...
                string strWhere = @" WHERE OB01997 = 0 AND NOT EXISTS(
                                ...
                                AND (OA01003 = 1 OR OA01003 =3)  and OA01013 <> '" + userId + "' ";
