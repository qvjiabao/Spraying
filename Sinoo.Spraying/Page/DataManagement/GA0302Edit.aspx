<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GA0302Edit.aspx.cs" Inherits="Sinoo.Spraying.Page.DataManagement.GA0302Edit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Edit City Date</title>
    <meta charset="UTF-8" />
...
<body class="ys">
    ...
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Data Management"><i
            class="icon-home"></i>Data Management </a><a href="#" title="" class="tip-bottom"
                data-original-title="City Data">City Data </a><a href="#" class="current">Edit City
                    Data</a>
    </div>
    <div class="container-fluid">
                    ...
                    <div class="xz">
                        <div class="control-group">
                            <label>
                                ...
                                <input type="hidden" name="Type" value="GA03EditCity" />
        ...
        <script src="/Scripts/page/Page_GA0302Edit.js" type="text/javascript"></script>
    </form>
</body>
</html>
