<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GA0302List.aspx.cs" Inherits="Sinoo.Spraying.Page.DataManagement.GA0302List" %>
...
<body class="ys">
    ...
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Data Management"><i class="icon-home">
        </i>Data Management </a><a href="#" class="current">City Date List</a>
    </div>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="taskOptions">
                                        <a href="GA0302Edit.aspx?GA03001=<%# Eval("GA03001") %>&PageIndex=<%=ViewState["PageIndex"] %>"
                                            class="tip-top" name="Edit" data-original-title="编辑"><i class="icon-pencil"></i></a>&nbsp;&nbsp;
                                        <asp:LinkButton class="tip-top" name="Del" data-original-title="删除" ID="lbtnRemoveData" CommandArgument='<%# Eval("GA03001") %>'
    ...
    <script src="/Scripts/page/Page_GA0302List.js" type="text/javascript"></script>
    </form>
</body>
</html>
