                ...
                <div class="content-box">
                    ...
                    <div class="xz tab-content">
                        ...
                        <div class="tab-pane" id="fapiao">
                            <table width="100%%" class="table table-bordered table-striped table-hover with-check zhong nomargin">
                                <thead>
                                    <th width="3.66%" scope="col">
                                        S/N
                                    </th>
                                    <th width="9.66%" scope="col">
                                        Part NO
                                    </th>
                                    <th width="4.66%" scope="col">
                                        Qty
                                    </th>
                                    <th width="8.66%" scope="col">
                                        Arrived
                                    </th>
                                    <th width="6.66%" scope="col">
                                        Arrival No
                                    </th>
                                    <th width="6.66%" scope="col">
                                        Arrival Date
                        ...
                        <div class="tab-pane" id="fukuan">
                            <table width="100%%" class="table table-bordered table-striped table-hover with-check zhong nomargin">
                                ...
                                <tbody id="TableBodyfukuan">
                                    ...
                                    <tr>
                                        <td colspan="4" style="text-align: right;">
                                            Outsanding：<asp:Label ID="labOP01015" runat="server" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" style="text-align: right;">
                                            Debts：<asp:Label ID="labOP01016" runat="server" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
