<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OA0102Edit.aspx.cs" Inherits="Sinoo.Spraying.Page.SalesManagement.OA0102Edit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Edit Goods Return</title>
    <meta charset="UTF-8" />
...
<body class="ys">
    ...
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Sales Management"><i
            class="icon-home"></i>Sales Management</a><a href="#" title="" class="tip-bottom"
                data-original-title="Edit Goods Return">Edit Goods Return</a><a href="#" class="current">Edit
                    Goods Return</a>
    </div>
                        ...
                        <div class="tab-pane active" id="dingdan">
                            <div class="control-group">
                                <label>
                                    ...
                                    <input type="hidden" name="Type" value="OA0102Edit" />
                            ...
                            <div class="control-group">
                                <label onclick="return false;">
                                    ...
                                    <asp:TextBox ID="txtOA01015" runat="server" ReadOnly="true" Style="width: 94px;"
                            ...
                            <div class="control-group">
                                <label>
                                    <label onclick="return false;">
                                        ...
                                        <asp:TextBox ID="txtOA01017" runat="server" ReadOnly="true" Style="width: 94px;"
                                            placeholder="点击选择"></asp:TextBox>
                                        &nbsp;
                            ...
                            <div class="control-group">
                                <label>
                                    ...
                                    <input id="txtOA01020" readonly="readonly" name="txtOA01020" runat="server" type="text" />
                                </label>
                            </div>
                            <div class="control-group">
                                <label>
                            ...
                            <div class="control-group">
                                <label>
                                    <span>Amount(US$)：</span>
                                    <input id="txtOA01022" readonly="readonly" name="txtOA01022" runat="server" type="text" />
                                </label>
                            </div>
                            <div class="control-group">
                                <label>
                                    ...
                                    <asp:Repeater ID="rptmingxi" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:" name="btnSave" onclick="EditProduct(this,'Edit')">修改</a> <a
                                                        href="javascript:" name="btnDelete" onclick="RemoveProduct(this)">删除</a>
                                                </td>
                                    ...
                                    <asp:Repeater ID="rptfapiao" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <span name="Arrived">
                                                        <%# Eval("OC01007").ToString()=="0"?"N":"Y" %></span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <span name="Delivered">
                                                        <%# Eval("OC01014").ToString()=="0"?"N":"Y" %></span></span>
                                                </td>
                                                <td>
    ...
    <script src="/Scripts/page/Page_OA0102Edit.js" type="text/javascript"></script>
