<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OA0101New.aspx.cs" Inherits="Sinoo.Spraying.Page.SalesManagement.OA0101New" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Add Orders Data</title>
    <meta charset="UTF-8" />
...
<body class="ys">
    <form id="form1" runat="server">
        ...
        <div id="breadcrumb">
            <a href="#" title="" class="tip-bottom" data-original-title="Sales Management"><i
                class="icon-home"></i>Sales Management</a><a href="#" title="" class="tip-bottom"
                    data-original-title="Orders Date">Orders Date</a><a href="#" class="current">Add Orders
                    Date</a>
        </div>
                            ...
                            <div class="tab-pane active" id="dingdan">
                                ...
                                <div class="control-group">
                                    <label>
                                        ...
                                        <input type="hidden" name="Type" value="OA0101New" />
                                ...
                                <div class="control-group">
                                    <label>
                                        ...
                                        <label class="radio inline">
                                            <asp:RadioButton GroupName="rbtnOA01005" Checked="true" ID="rbtnOA01005No" runat="server" />否
                                        </label>
                                    </label>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label>
                                        ...
                                        <label class="radio inline">
                                            <asp:RadioButton GroupName="rbtnOA01024" ID="rbtnOA01024No" runat="server" Checked="true"
                                                onclick="$('#txtOA01024').val('')" />否
                                        </label>
                                        <label class="radio inline" style="margin-left: -15px;" onclick="return false;">
                                            <asp:TextBox ID="txtOA01024" MaxLength="100" runat="server" Style="width: 120px;"
                                                data-rule="length[1~100, true]" onblur="changeInputCheck(this,'rbtnOA01024Yes')"></asp:TextBox>
                                        </label>
                                    </label>
                                </div>
                                <div class="control-group">
                                    <label>
                                        ...
                                        <label class="radio inline">
                                            <asp:RadioButton GroupName="rbtnOA01048" ID="rbtnOA01048No" runat="server" Checked="true"
                                                onclick="$('#txtOA01048').val('')" />否
                                        </label>
                                        <label class="radio inline" style="margin-left: -15px;" onclick="return false;">
                                ...
                                <div class="control-group">
                                    <label>
                                        ...
                                        <asp:DropDownList ID="ddlOA01025" runat="server" data-rule="AC: required">
                                        </asp:DropDownList>
                                    </label>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label>
                                        ...
                                        <label class="radio inline">
                                            <asp:RadioButton GroupName="rbtnOA01003" ID="rbtnOA01003No" runat="server" Checked="true" />否
                                        </label>
                                    </label>
                                </div>
                                <div class="control-group">
                                    <label>
                                        ...
                                        <label class="radio inline">
                                            <asp:RadioButton GroupName="rbtnOA01044" ID="rbtnOA01044No" runat="server" Checked="true" />否
                                        </label>
                                    </label>
                                </div>
                                <div class="control-group">
                                    <label>
                                        ...
                                        <label class="radio inline">
                                            <asp:RadioButton GroupName="rbtnOA01045" ID="rbtnOA01045No" runat="server" Checked="true" />否
                                        </label>
                                    </label>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label>
                                        ...
                                        <%-- <asp:TextBox ID="txtOA01047" runat="server" TextMode="MultiLine"></asp:TextBox>--%>
                                        <asp:DropDownList ID="ddlOA01047" runat="server">
                                        </asp:DropDownList>
                                    </label>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label>
                                        ...
                                        <asp:TextBox ID="txtOA01028" onblur="GoodsInlnvoice(this)" runat="server"></asp:TextBox>
                                    </label>
                                </div>
                                <div class="control-group">
                                    <label>
                                        <span>Consignee(Goods)：</span>
                                        <asp:TextBox ID="txtOA01029" onblur="GoodsInlnvoice(this)" runat="server"></asp:TextBox>
                                    </label>
                                </div>
                                <div class="control-group">
                                    <label>
                                        <span>Tel/MP(Goods)：</span>
                                        <asp:TextBox ID="txtOA01030" onblur="GoodsInlnvoice(this)" runat="server"></asp:TextBox>
                                    </label>
                                </div>
                                <div class="control-group">
                                    <label>
                                        <span>Post code(Goods)：</span>
                                        <asp:TextBox ID="txtOA01031" onblur="GoodsInlnvoice(this)" runat="server"></asp:TextBox>
                                    </label>
                                </div>
                                <div class="control-group">
                                    <label>
        ...
        <script src="/Scripts/page/Page_OA0101New.js?v=1.0" type="text/javascript"></script>
