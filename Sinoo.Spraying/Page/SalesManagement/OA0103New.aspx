<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OA0103New.aspx.cs" Inherits="Sinoo.Spraying.Page.SalesManagement.OA0103New" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Add Order File</title>
    <meta charset="UTF-8" />
    ...
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Sales Management"><i
            class="icon-home"></i>Sales Management</a><a href="#" title="" class="tip-bottom"
                data-original-title="Order File"><i class="icon-home"> </i>Order File</a><a href="#"
                    class="current">Add Order File</a>
    </div>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="content-box">
                    <div class="content-h">
                        <div class="bh">
                            <i class="icon-plus-sign"></i><span>Add Order File</span></div>
                    </div>
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#jiben" data-toggle="tab">Order File</a></li>
                    </ul>
                    <div class="xz tab-content">
                        <div class="tab-pane active" id="jiben">
                            ...
                            <div class="control-group" id="div3">
                                <label>
                                    <span>Order No：</span>
                                    <asp:Label ID="txtOA01002" runat="server"></asp:Label>
                                </label>
                            </div>
                            ...
                            <div>
                                <input type="button" class="btn btn-primary" value="添加文件" onclick="addFile()" />
                            </div>
                        </div>
                    </div>
                </div>
