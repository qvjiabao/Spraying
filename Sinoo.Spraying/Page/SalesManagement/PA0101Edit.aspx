<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PA0101Edit.aspx.cs" Inherits="Sinoo.Spraying.Page.SalesManagement.PA0101Edit" %>
...
<body class="ys">
    ...
    <div id="breadcrumb">
        ...
        </a><a href="#" class="current">Edit Product Data</a>
    </div>
    <div class="container-fluid">
                    ...
                    <div class="xz">
                        <div class="control-group">
                            <label>
                                ...
                                <input type="hidden" name="Type" value="PA01Edit" />
        ...
        <script src="/Scripts/page/Page_PA0101Edit.js" type="text/javascript"></script>
    </form>
</body>
</html>
