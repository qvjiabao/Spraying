<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UA0101Edit.aspx.cs" Inherits="Sinoo.Spraying.Page.UserManagement.UA0101Edit" %>
...
<body class="ys">
    ...
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="User Management"><i
            class="icon-home"></i>User Management </a><a href="#" title="" class="tip-bottom"
                data-original-title="User Data">User Data </a><a href="#" class="current">Edit User
                    Data</a>
    </div>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="content-box">
                    <div class="content-h">
                        <div class="bh">
                            <i class="icon-pencil"></i><span>Edit</span></div>
                    </div>
                    <div class="xz">
                        <div class="control-group">
                            <label>
                                <span>用户姓名：<font style="color: Red">*</font></span>
                                <input type="hidden" name="UA01001" id="UA01001" runat="server" />
                        ...
                        <div class="control-group">
                            <label>
                                ...
                                <input type="hidden" name="Type" value="UA01007Edit" />
                        ...
                        <div class="control-group">
                            <label>
                                ...
                                <asp:DropDownList ID="ddlUA01013" runat="server" data-rule="checked;required" data-msg-required="请选择所属区域">
                                </asp:DropDownList>
                            </label>
                        </div>
                        <div class="control-group">
                            <label>
                                <span>入职时间：</span>
                                <asp:TextBox ID="txtUA01016" onClick="WdatePicker({maxDate:'%y-%M-%d'})" CssClass="Wdate"
                        ...
                        <div class="control-group">
                            <label>
                                ...
                                <input type="hidden" name="Type1" value="UA01002Edit" />
                        ...
                        <div class="control-group">
                            <label>
                                <span>系统密码：</span>
                                <asp:TextBox ID="txtUA01003" runat="server" TextMode="Password" data-rule="系统密码:length[1~20, true]"></asp:TextBox>
                            </label>
                        </div>
                        <div class="control-group">
                            <label>
                                <span>确认系统密码：</span>
                                <asp:TextBox ID="txtUA01003Again" runat="server" TextMode="Password" data-rule="确认系统密码: match(txtUA01003)"></asp:TextBox>
                            </label>
                        </div>
                    </div>
                </div>
    ...
    <script src="/Scripts/page/Page_UA0101Edit.js" type="text/javascript"></script>
