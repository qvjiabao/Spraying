<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GA0201Edit.aspx.cs" Inherits="Sinoo.Spraying.Page.UserManagement.GA0201Edit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Edit Role Data</title>
    <meta charset="UTF-8" />
    ...
    <script src="/Scripts/page/Page_GA0201Edit.js" type="text/javascript"></script>
</head>
<body class="ys">
    ...
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="User Management"><i
            class="icon-home"></i>User Management </a><a href="#" title="" class="tip-bottom"
                data-original-title="Role Data">Role Data </a><a href="#" class="current">Edit Role
                    Data</a>
    </div>
    <div class="container-fluid">
                ...
                <div class="xz">
                    <div class="control-group">
                        <label>
                            ...
                            <asp:TextBox ID="txtGA02002" data-rule="required;length[1~20, true];" runat="server"></asp:TextBox>
                            <input type="hidden" name="Type" value="GA02Edit" />
        ...
        <div class="row-fluid">
            <div class="page-footer">
                <asp:Button ID="btnSave" OnClientClick="return DataSave()" CssClass="btn btn-primary"
                    runat="server" Text="保 存" OnClick="btnSave_Click" />
                &nbsp;
                <asp:Button ID="btnReturn" novalidate class="btn btn-primary" runat="server" Text="返 回"
