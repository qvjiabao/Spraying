<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CA0101Edit.aspx.cs" Inherits="Sinoo.Spraying.Page.CustomerManagement.CA0101Edit" %>
...
<body class="ys">
    <form id="form1" runat="server">
        ...
        <div id="breadcrumb">
            <a href="#" title="" class="tip-bottom" data-original-title="Customer Management"><i
                class="icon-home"></i>Customer Management</a><a href="#" title="" class="tip-bottom"
                    data-original-title="Customer Data">Customer Data</a> <a href="#" class="current">Edit
                    Customer</a>
        </div>
                            ...
                            <div class="tab-pane active" id="jiben">
                                <div class="control-group">
                                    <label>
                                        ...
                                        <input type="hidden" name="Type" value="CA01Edit" />
                                ...
                                <div class="control-group">
                                    <label>
                                        ...
                                        <asp:DropDownList ID="ddlCA01019" runat="server" data-rule="MDT:required">
                                        </asp:DropDownList>
                                    </label>
                                </div>
                                <div class="control-group">
        ...
        <script src="/Scripts/page/Page_CA0101Edit.js" type="text/javascript"></script>
