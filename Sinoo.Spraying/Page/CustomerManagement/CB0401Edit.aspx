<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CB0401Edit.aspx.cs" Inherits="Sinoo.Spraying.Page.CustomerManagement.CB0401Edit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Edit Customer SIC</title>
    <meta charset="UTF-8" />
...
<body class="ys">
    ...
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Customer Management"><i
            class="icon-home"></i>Customer Management</a><a href="#" title="" class="tip-bottom"
                data-original-title="Customer SIC">Customer SIC</a> <a href="#" class="current">Edit
                    Customer SIC</a>
    </div>
    <div class="container-fluid">
                    ...
                    <div class="xz">
                        <div class="control-group">
                            <label>
                                ...
                                <input type="hidden" name="Type" value="CB04Edit" />
        ...
        <script src="/Scripts/page/Page_CB0401Edit.js" type="text/javascript"></script>
    </form>
</body>
</html>
