<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoicesAmountOfMoney.aspx.cs"
    Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.InvoicesAmountOfMoney" %>
...
<head id="Head1" runat="server">
    ...
    <title>Invoice Amount List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>
            Invoice Amount List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Invoice Amount
                List</a>
    </div>
                    ...
                    <div class="content-bd">
                        <table width="100%" id="tb1" class="table table-bordered table-striped table-hover with-check zhong nomargin">
                            ...
                            <asp:Repeater runat="server" ID="rpGA03">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <%# Eval("sumus") == DBNull.Value ? "" : Math.Round(Convert.ToDecimal(Eval("sumus")), 2).ToString()%>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                            <tr>
                                ...
                                <td>
                                    合计(RMB)：
                                    <asp:Label ID="labrmb" runat="server" Text="0.00"></asp:Label>
                                </td>
                                <td>
                                    合计(US$)：
                                    <asp:Label ID="labus" runat="server" Text="0.00"></asp:Label>
                                </td>
                            </tr>
                        </table>
    ...
    <script src="/Scripts/page/Page_InvoicesAmountOfMoney.js?v=1.1" type="text/javascript"></script>
    </form>
</body>
</html>
