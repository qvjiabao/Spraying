<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="SalesbyCTC.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.SalesbyCTC" %>
...
<head id="Head1" runat="server">
    ...
    <title>Sales by CTC List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>
            Sales by CTC List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Sales by CTC
                List</a>
    </div>
                ...
                <div class="content-box">
                    ...
                    <div class="content-bd">
                        <table width="100%" id="tb1" class="table table-bordered table-striped table-hover with-check zhong nomargin">
                            ...
                            <asp:Repeater runat="server" ID="repCTC">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <%# Eval("CB02002")%>
    ...
    <script src="/Scripts/page/Page_SalesbyCTC.js?v=1.0" type="text/javascript"></script>
