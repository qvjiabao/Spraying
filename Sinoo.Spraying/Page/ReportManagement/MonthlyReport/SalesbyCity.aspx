<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="SalesbyCity.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.SalesbyCity" %>
...
<head id="Head1" runat="server">
    ...
    <title>Sales by City List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>
            Sales by City List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Sales by City
                List</a>
    </div>
                        ...
                        <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-helper-clearfix nomargin">
                            <div class="dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-multi paging_full_numbers"
                                ...
                                <webdiyer:AspNetPager ID="AspNetPager1" CssClass="paginator" CurrentPageButtonClass="cpb"
                                    ...
                                    CustomInfoTextAlign="Left" LayoutType="Table" CustomInfoHTML="当前第 %CurrentPageIndex%页，共 %PageCount%页"  OnPageChanging="AspNetPager1_PageChanging">
    ...
    <script src="/Scripts/page/Page_SalesbyCity.js?v=1.0" type="text/javascript"></script>
