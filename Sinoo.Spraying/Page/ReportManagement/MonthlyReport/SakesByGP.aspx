<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="SakesByGP.aspx.cs"
    Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.SakesByGP" %>
...
<body class="ys">
    ...
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Sales By GP
                List</a>
    </div>
                ...
                <div class="content-box">
                    <div class="content-h">
                        ...
                        <div class="control-group control-anniu">
                            <asp:Button ID="Button2" Text="  导 出  " runat="server" OnClientClick="javascript:return confirm('您确定导出数据吗？')"
                    ...
                    <div class="content-bd">
                        <table width="100%" id="tb1" class="table table-bordered table-striped table-hover with-check zhong nomargin">
                            ...
                            <asp:Repeater runat="server" ID="repSIC">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <%# Eval("OA01002")%>
                                        ...
                                        <td>
                                            <%# Eval("OA01019") == DBNull.Value ? "" : Math.Round(Convert.ToDecimal(Eval("OA01019")), 2).ToString()%>
                                        </td>
                                        <td>
                                            <%# Eval("Profit") == DBNull.Value ? "" : Math.Round(Convert.ToDecimal(Eval("Profit")), 2).ToString()%>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
    ...
    <script src="/Scripts/page/Page_SakesByGP.js?v=1.0" type="text/javascript"></script>
