<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopCustomerTwo.aspx.cs"
    Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.TopCustomerTwo" %>
...
<head id="Head1" runat="server">
    ...
    <title>Top Customer2 List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>
            Top Customer2 List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Top Customer2
                List </a>
    </div>
                    ...
                    <div class="xz">
                        <div class="control-group">
                            <label>
                                ...
                                <asp:TextBox ID="txtBeginOrderTime" onclick="WdatePicker({dateFmt:' yyyy'})"
                            ...
                            <asp:Repeater runat="server" ID="rpGA03">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <%# Eval("SalesName") == DBNull.Value ? "" : Eval("SalesName").ToString()%>
                                        </td>
                                        <td>
                                            <%# Eval("SIC")%>
                                        </td>
                                        ...
                                        <td>
                                            <%# Eval("SalesUSD") == DBNull.Value ? "" : Math.Round(Convert.ToDecimal(Eval("SalesUSD")), 2).ToString()%>
                                        </td>
                                        <td>
                                            <%# Eval("Orders")%>
                                        </td>
                                        <td>
                                            <%# Eval("SalesUSDNew") == DBNull.Value ? "" : Math.Round(Convert.ToDecimal(Eval("SalesUSDNew")), 2).ToString()%>
                                        </td>
                                        <td>
                                            <%# Eval("OrdersNew")%>
                                        </td>
    ...
    <script src="/Scripts/page/Page_TopCustomerTwo.js" type="text/javascript"></script>
