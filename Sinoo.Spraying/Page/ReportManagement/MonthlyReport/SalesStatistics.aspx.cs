...
{
    public partial class SalesStatistics : BasePage
    {
        ...
        private void InitData(int Index, bool bl)
        {
            ...
            DataTable dt = _ReportBLL.SelectMonthlySalesStatistics(AspNetPager1.PageSize, Index, strWhere, blInvoice, ref RowCount);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = _ExcelBLL.ExportSalesB(GetSqlWhere(), blInvoice);
            if (ds.Tables[0].Rows.Count > 0)
            {
                this.DownloadFile(ds, "Salesengineer.xls", "UA01.xml");
            }
            else
            {
