<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="ByCustomerName.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.ByCustomerName" %>
...
<head id="Head1" runat="server">
    ...
    <title>By Customer Name List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>
            By Customer Name List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">By Customer
                Name List</a>
    </div>
                    ...
                    <div class="xz">
                        <div class="control-group">
                            <label>
                                ...
                                <asp:TextBox ID="txtCA01003" runat="server"></asp:TextBox>
                            </label>
                        </div>
                        <div class="control-group">
                            <label>
                ...
                <div class="content-box">
                    ...
                    <div class="content-bd">
                        <table width="100%" id="tb1" class="table table-bordered table-striped table-hover with-check zhong nomargin">
                            ...
                            <asp:Repeater runat="server" ID="repByCustomerName">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <%# Eval("CA01003")%>
                                        ...
                                        <td>
                                            <%# Eval("OrderMoney") == DBNull.Value ? "" : Math.Round(Convert.ToDecimal(Eval("OrderMoney")), 2).ToString()%>
                                        </td>
                                        <td>
                                            <%# Eval("OrderCount")%>
                                        </td>
    ...
    <script src="/Scripts/page/Page_ByCustomerName.js?v=1.0" type="text/javascript"></script>
