<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="HotPartList.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.HotPartList" %>
...
<body class="ys">
    ...
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Hot Part List</a>
    </div>
                ...
                <div class="content-box">
                    ...
                    <div class="content-bd">
                        <table width="100%" id="tb1" class="table table-bordered table-striped table-hover with-check zhong nomargin">
                            ...
                            <asp:Repeater runat="server" ID="repHotPart">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <%# Eval("OB01005")%>
    ...
    <script src="/Scripts/page/Page_HotPartList.js?v=1.0" type="text/javascript"></script>
