<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="TopCustomer.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.TopCustomer" %>
...
<body class="ys">
    ...
    <div id="content-header">
        <h1>
            Top Customer List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Top Customer
                List</a>
    </div>
    ...
    <script src="/Scripts/page/Page_TopCustomer.js?v=1.0" type="text/javascript"></script>
