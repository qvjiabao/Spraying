<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnpaidFirstShipment.aspx.cs"
    Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.UnpaidFirstShipment" %>
...
<head id="Head1" runat="server">
    ...
    <title>UnpaidFirstShipment List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>
            UnpaidFirstShipment List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">UnpaidFirstShipment
                List</a>
    </div>
    ...
    <script src="/Scripts/page/Page_UnpaidFirstShipment.js?v=1.0" type="text/javascript"></script>
    </form>
</body>
</html>
