...
{
    public partial class HotPartListTwo : System.Web.UI.Page
    {
        ...
        public string GetSqlWhere()
        {
            ...
            {
                strWhereAdd += string.Format(" AND UA01013 = '{0}'", Request.Form["ddlUA01"]);
            }
            return strWhereAdd;
        }
        ...
        private void InitData(int Index, bool bl)
        {
            ...
            DataTable dt = _ReportBLL.SelectMonthlyHotPartListTwoPage(AspNetPager1.PageSize, Index, strWhere, ref RowCount);
            if (dt.Rows.Count > 0)
            {
