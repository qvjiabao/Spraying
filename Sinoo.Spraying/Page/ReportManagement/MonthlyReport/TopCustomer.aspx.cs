...
{
    public partial class TopCustomer : BasePage
    {
        ...
        private void InitData(int Index, bool bl)
        {
            ...
            DataTable dt = _ReportBLL.SelectMonthlyTopCustomerPage(AspNetPager1.PageSize, Index, strWhere, blInvoice,ref RowCount);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = _ExcelBLL.ExportTopCustomer(GetSqlWhere(), blInvoice);
            if (ds.Tables[0].Rows.Count > 0)
            {
                this.DownloadFile(ds, "TopCustomer.xls", "TopCustomer.xml");
            }
            else
            {
