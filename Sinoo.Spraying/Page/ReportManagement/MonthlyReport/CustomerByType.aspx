<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="CustomerByType.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.CustomerByType" %>
...
<head id="Head1" runat="server">
    ...
    <title>By Customer Type List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>
            By Customer Type List
        </h1>
    </div>
    <div id="breadcrumb">
    ...
    <script src="/Scripts/page/Page_CustomerByType.js?v=1.0" type="text/javascript"></script>
