...
namespace Sinoo.Spraying.Page.ReportManagement.MonthlyReport
{
    ...
    public partial class UnpaidFirstShipment : BasePage
    {
        ...
        private void InitData(int Index, bool bl)
        {
            ...
            DataTable dt = _ReportBLL.SelectUnpaidFirstShipmentPage(AspNetPager1.PageSize, Index, strWhereAdd, ref RowCount);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void btnExPort_Click(object sender, EventArgs e)
        {
            ...
            DataSet dt = _ExcelBLL.ExportUnpaidFirstShipmentPage(strWhereAdd);
            if (dt.Tables[0].Rows.Count > 0)
            {
                this.DownloadFile(dt, "UnpaidFirstShipment.xls", "UnpaidFirstShipment.xml");
            }
            else
            {
