<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="SalesStatistics.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.SalesStatistics" %>
...
<head id="Head1" runat="server">
    ...
    <title>Sales engineer List</title>
</head>
<body class="ys">
    ...
    <div id="content-header">
        <h1>
            Sales engineer List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Sales engineer
                List</a>
    </div>
    ...
    <script src="/Scripts/page/Page_SalesStatistics.js?v=1.0" type="text/javascript"></script>
