...
{
    public partial class TopCustomerTwo : System.Web.UI.Page
    {
        ...
        private void InitData(int Index, bool bl)
        {
            ...
            {
                DataTable dtUserBaseByAera = _UserBLL.SelectUserBaseByAera(string.Format(" AND UA01013 = '{0}'", Request.Form["ddlProvince"]));
        ...
        private string[] GetWhere(bool bl)
        {
            ...
            if (!string.IsNullOrEmpty(Request.Form["ddlProvince"]) && Request.Form["ddlProvince"] != "")
            {
                strWhereAdd[0] += string.Format(" AND UA01013 = '{0}'", Request.Form["ddlProvince"]);
            }
