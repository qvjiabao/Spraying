<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="HotPartListTwo.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.HotPartListTwo" %>
...
<body class="ys">
    ...
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Hot Part List2</a>
    </div>
                    ...
                    <div class="xz">
                        ...
                        <div class="control-group">
                            <button class="btn btn-primary" type="button" id="demoBtn3">
                                高级查询</button>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="Button2" CssClass="btn btn-primary" runat="server" Text="  查 询  "
    ...
    <script src="/Scripts/page/Page_HostPartListTwo.js" type="text/javascript"></script>
