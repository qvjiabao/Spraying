<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="KeyCustomer.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.KeyCustomer" %>
...
<head id="Head1" runat="server">
    ...
    <title>Key Customer List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>
            Key Customer List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Key Customer
                List</a>
    </div>
                ...
                <div class="content-box">
                    ...
                    <div class="content-bd">
                        <table width="100%" id="tb1" class="table table-bordered table-striped table-hover with-check zhong nomargin">
                            ...
                            <asp:Repeater runat="server" ID="repKeyCustomer">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <%# Eval("OLDSUMRMB") == DBNull.Value ? "" : Math.Round(Convert.ToDecimal(Eval("OLDSUMRMB")), 2).ToString()%>
                                        </td>
                                        <td>
                                            <%# Eval("OLDSUMUD") == DBNull.Value ? "" : Math.Round(Convert.ToDecimal(Eval("OLDSUMUD")), 2).ToString()%>
                                        </td>
                                        <td>
                                            <%# Eval("OLDORDERCOUNT")%>
                                        </td>
                                        <td>
                                            <%# Eval("SUMRMB") == DBNull.Value ? "" : Math.Round(Convert.ToDecimal(Eval("SUMRMB")), 2).ToString()%>
                                        </td>
                                        <td>
                                            <%# Eval("SUMUD") == DBNull.Value ? "" : Math.Round(Convert.ToDecimal(Eval("SUMUD")), 2).ToString()%>
                                        </td>
                                        <td>
                                            <%# Eval("ORDERCOUNT")%>
                                        </td>
    ...
    <script src="/Scripts/page/Page_KeyCustomer.js?v=1.0" type="text/javascript"></script>
