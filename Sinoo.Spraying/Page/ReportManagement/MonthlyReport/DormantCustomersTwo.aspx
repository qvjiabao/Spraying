<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="DormantCustomersTwo.aspx.cs"
    Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.DormantCustomersTwo" %>
...
<head id="Head1" runat="server">
    ...
    <title>Dormant Customers2 List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>Dormant Customers2</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Dormant Customers2</a>
    </div>
