...
{
    public partial class SalesYear : System.Web.UI.Page
    {
        ...
        private void InitData(int Index, bool bl)
        {
            ...
            DataTable dt = _ReportBLL.SelectSalesYearPage(AspNetPager1.PageSize, Index, strWhereAdd,blInvoice, ref RowCount);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void btnExPort_Click(object sender, EventArgs e)
        {
            ...
            DataSet dt = _ExcelBLL.ExportSalesYearPage(strWhereAdd, blInvoice);
            if (dt.Tables[0].Rows.Count > 0)
            {
                this.DownloadFile(dt, "SalesYear.xls", "SalesYear.xml");
            }
            else
            {
