<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="SalesbySIC.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.MonthlyReport.SalesbySIC" %>
...
<head id="Head1" runat="server">
    ...
    <title>Sales By SIC List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>
            Sales By SIC List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Sales By SIC
                List</a>
    </div>
    ...
    <script src="/Scripts/page/Page_SalesbySIC.js?v=1.0" type="text/javascript"></script>
