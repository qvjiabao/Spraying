...
{
    public partial class SalesbySIC : System.Web.UI.Page
    {
        ...
        private void InitData(int Index, bool bl)
        {
            ...
            bool blInvoice = false || (!string.IsNullOrEmpty(this.txtBeginInvoiceTime.Text.Trim())||!string.IsNullOrEmpty(this.txtEndInvoiceTime.Text.Trim()));

            AspNetPager1.AlwaysShow = false;
            AspNetPager1.PageSize = 15;
            object RowCount = null;
            DataTable dt = _ReportBLL.SelectMonthlySICPage(AspNetPager1.PageSize, Index, strWhere, blInvoice,ref RowCount);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = _ExcelBLL.ExportSalesbySIC(GetSqlWhere(), blInvoice);

            if (ds.Tables[0].Rows.Count > 0)
            {
                this.DownloadFile(ds, "SalesbySIC.xls", "SalesbySIC.xml");
            }
            else
            {
