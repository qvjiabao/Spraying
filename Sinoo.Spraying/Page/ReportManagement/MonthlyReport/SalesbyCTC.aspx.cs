...
{
    public partial class SalesbyCTC : System.Web.UI.Page
    {
        ...
        private void InitData(int Index, bool bl)
        {
            ...
            DataTable dt = _ReportBLL.SelectMonthlyCTCPage(AspNetPager1.PageSize, Index, strWhere, blInvoice,ref RowCount);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = _ExcelBLL.ExportsalesbyCTC(GetSqlWhere(),blInvoice);
            if (ds.Tables[0].Rows.Count > 0)
            {
                this.DownloadFile(ds, "SalesbyCTC.xls", "SalesbyCTC.xml");
            }
            else
            {
