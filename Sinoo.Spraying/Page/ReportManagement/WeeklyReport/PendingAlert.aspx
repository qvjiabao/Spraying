<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendingAlert.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.WeeklyReport.PendingAlert" %>
...
<head id="Head1" runat="server">
    ...
    <title>Pending Alert List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>
            Pending Alert List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Pending Alert
                List</a>
    </div>
                            ...
                            <asp:Repeater runat="server" ID="rpGA03">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <%# Eval("OC01009") == DBNull.Value ? "无" : Convert.ToDateTime(Eval("OC01009")).ToString("yyyy-MM-dd")%>
                                        </td>
                                        <td>
                                            <%# Eval("OC01015") == DBNull.Value ? "" : Convert.ToDateTime(Eval("OC01015")).ToString("yyyy-MM-dd")%>
                                        </td>
                                        <td>
                                            <%# Eval("OA01010") == DBNull.Value ? "无" : Convert.ToDateTime(Eval("OA01010")).ToString("yyyy-MM-dd")%>
                                        </td>
                                        <td>
                                            <%# Eval("Pendingdays") %>
                                        </td>
    ...
    <script src="/Scripts/page/Page_PendingAlert.js?v=1.1" type="text/javascript"></script>
    </form>
</body>
</html>
