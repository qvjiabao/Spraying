...
{
    public partial class DebtsAlert : System.Web.UI.Page
    {
        ...
        private void InitData(int Index, bool bl)
        {
            ...
            string strWhereAdd = this.GetWhere(bl); //获取查询条件
            ...
            DataTable dt = _ReportBLL.SelectDebtsAlertPage(AspNetPager1.PageSize, Index, strWhereAdd,blInvoice,ref RowCount);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                this.txtBeginOrderTime.Text = monday.ToString("yyyy-MM-dd");
                this.txtEndOrderTime.Text = DateTime.Now.AddDays(dayadd).ToString("yyyy-MM-dd"); ;
