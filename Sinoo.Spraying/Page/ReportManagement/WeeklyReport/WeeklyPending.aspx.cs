...
{
    public partial class WeeklyPending : System.Web.UI.Page
    {
        ...
        private void InitData(int Index, bool bl)
        {
            ...
            DataTable dt = _ReportBLL.SelectWeeklyPendingPage(AspNetPager1.PageSize, Index, strWhereAdd, ref RowCount);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void btnExPort_Click(object sender, EventArgs e)
        {
            ...
            DataSet dt = _ExcelBLL.ExportWeeklyPendingPage(strWhereAdd);
            if (dt.Tables[0].Rows.Count > 0)
            {
                this.DownloadFile(dt, "WeeklyPending.xls", "WeeklyPending.xml");
            }
            else
            {
