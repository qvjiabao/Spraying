<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="NewArrival.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.DailyReport.NewArrival" %>
...
<body class="ys">
    ...
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">New Arrival
                List</a>
    </div>
    ...
    <script src="/Scripts/page/Page_NewArrival.js?v=1.0" type="text/javascript"></script>
