<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="DaliyCollection.aspx.cs" Inherits="Sinoo.Spraying.Page.ReportManagement.DailyReport.DaliyCollection" %>
...
<head id="Head1" runat="server">
    ...
    <title>Daliy Collection List</title>
</head>
<body class="ys">
    <form id="form1" runat="server">
    <div id="content-header">
        <h1>
            Daliy Collection List</h1>
    </div>
    <div id="breadcrumb">
        <a href="#" title="" class="tip-bottom" data-original-title="Report Management"><i
            class="icon-home"></i>Report Management </a><a href="#" class="current">Daliy Collection
                List</a>
    </div>
                    ...
                    <div class="xz">
                        <div class="control-group">
                            <label onclick="return false">
                                ...
                                <asp:TextBox ID="txtOP01DateStart" runat="server" onClick="WdatePicker({maxDate:'#F{$dp.$D(\'txtOP01DateEnd\')}'})"
                                    CssClass="Wdate" Style="width: 92px; background-position: 82px 7px;"></asp:TextBox>
                                -
                                <asp:TextBox ID="txtOP01DateEnd" runat="server" onClick="WdatePicker({minDate:'#F{$dp.$D(\'txtOP01DateStart\')}'})"
                                    CssClass="Wdate" Style="width: 92px; background-position: 82px 7px;"></asp:TextBox>
                            </label>
                        </div>
                        <div class="control-group">
                ...
                <div class="content-box">
                    ...
                    <div class="content-bd" style="overflow: scroll;">
                        <table width="100%%" id="tb1" class="table table-bordered table-striped table-hover with-check zhong nomargin">
                            ...
                            <asp:Repeater runat="server" ID="repDaliyCollection">
                                <ItemTemplate>
                                    <tr>
                                        <td>
    ...
    <script src="/Scripts/page/Page_DaliyCollection.js?v=1.0" type="text/javascript"></script>
