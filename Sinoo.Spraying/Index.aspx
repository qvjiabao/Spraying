...
<body>
    <form id="Form1" runat="server">
        ...
        <div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav btn-group">
                <li class="btn btn-inverse"><a title="" href="Index.aspx" id="A1"><i class="icon icon-share-alt"></i><span class="text">首页</span></a></li>
                ...
                <li class="btn btn-inverse"><a title="" href="/Login.aspx" id="runDemo1"><i class="icon icon-share-alt"></i><span class="text">退出</span></a></li>
            </ul>
        </div>
        <div class="concat">
            <div id="sidebar">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function (e) {
            ...
            $.post("/Handler/TipHandler.ashx", { flag: "checkOrders" }, function (result) {
                if (result !== "0") {
                    layer.open({
                        title: 'Debts & Pending',
                        type: 2,
                        ...
                        content: ['TipList.aspx?parameter=' + result]
                    });
                }
            });
        });
