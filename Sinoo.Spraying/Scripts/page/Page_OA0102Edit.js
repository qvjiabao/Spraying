...
function AddProductInput() {
    ...
    html += "<td><input type=\"text\"  maxlength=\"20\" onblur=\"checkNum(this);Sum(this)\"  name=\"UnitCost\" /></td>";
...
function EditProduct(obj) {
    ...
    html += "   <td><span name=\"NetAmount\">" + NetAmount + "</span></td>";
    html += "   <td><span name=\"TAX\">" + TAX + "</span></td>";
    html += "   <td><input type=\"text\"  maxlength=\"20\" onkeyup=\"checkNum(this)\" name=\"UnitCost\" onblur=\"Sum(this)\" value=" + Unit + " ></td>";
    html += "   <td><span name=\"TotalCost\">" + TotalCost + "</span></td>";
...
function btnClientSave() {
    ...
    $.ajax({
        ...
        data: { txtOA01002: txtOA01002, Type: Type, ID: ID },
        async: false,
