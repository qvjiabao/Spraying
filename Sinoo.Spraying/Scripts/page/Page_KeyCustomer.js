...
function SaveCustomerHtml() {
    ...
    var List;
    $.ajax({
        url: getdata.getControllerUrl() + "UserControlHandler.ashx?Type=Select&OB04001=" + $("#UserControl_txtFMenu").val() + "&time=" + new Date().getTime(),
        async: false,
        dataType: 'json',
        type: 'POST',
        cache: false,
    ...
    $.ajax({
        url: getdata.getControllerUrl() + "UserControlHandler.ashx?Type=Select&OB02001=" + $("#UserControl_txtOB02001").val() + "&time=" + new Date().getTime(),
        async: false,
        dataType: 'json',
        type: 'POST',
        cache: false,
