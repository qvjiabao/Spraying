...
function DataClear() {
    ...
    $("input[type='text']").val("");
    $("select").val("0");
    $("#rbtnOA01045No").attr("checked", true);
    $("#rbtnOA01044No").attr("checked", true);
    $("#rbtnOA01048No").attr("checked", true);
    $("#rbtnOA01024No").attr("checked", true);
    $("#rbtnOA01005Yes").attr("checked", false);
    $("#rbtnOA01005No").attr("checked", false);
    $("#rbtnOA01003No").attr("checked", true);
}
...
function btnClientSave() {
    ...
    $.ajax({
        ...
        data: { txtOA01002: $("#txtOA01002").val(), Type: "OA0101New" },
        async: false,
...
function GoodsInlnvoice(obj) {
    var objlength = obj.id.length;
    $("#" + obj.id.substring(0, objlength - 2) + (Number(obj.id.substring(objlength - 2, objlength)) + Number(4))).val(obj.value)
}
